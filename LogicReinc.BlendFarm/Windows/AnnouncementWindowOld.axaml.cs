...
{
    public partial class AnnouncementWindowOld : Window, INotifyPropertyChanged
    {
        ...
        public AnnouncementWindowOld(List<Announcement> announcements)
        {
